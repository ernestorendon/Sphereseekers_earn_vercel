...
public partial class ExitArea2 : Area3D
{
	...
	private void OnBodyEntered(Node body)
	{
		...
		if (body.Name == "Ball")
		{
			...
			// Stop the stopwatch
			var ui = GetNode<UI>("/root/Main/UI2");
			if (ui != null)
			{
				ui.StopStopwatch();
			}
			...
			{
				GD.PrintErr("UI node not found! Make sure the path '/root/Main/UI2' is correct.");
			}
	...
	private void LoadNextLevel()
	{
		...
		string nextLevelPath = "res://Scenes/Level3.tscn";
